...
def function_main_Plotting_Pt_Diff(selected_Column):
    ...
    plt.title('East Teams Point Gain-Loss History')
    plt.xlabel('Time')
    plt.ylabel('Point Gain-Loss')
    ...
    plt.title('West Teams Point Gain-Loss History')
    plt.xlabel('Time')
    plt.ylabel('Point Gain-Loss')
    ax.yaxis.set_ticks_position('both')
    leg = plt.legend(loc='upper left', fancybox=True, fontsize=9)
