...
def function_main_Plotting_Road_Win_Pctg(selected_Column):
    ...
    plt.title('East Teams Road Winning Percentage History')
    plt.xlabel('Time')
    ...
    plt.title('West Teams Road Winning Percentage History')
    plt.xlabel('Time')
    plt.ylabel('Percentage (%)')
    ax.yaxis.set_ticks_position('both')
    leg = plt.legend(loc='upper left', fancybox=True, fontsize=9)
