...
def function_main_Plotting_Home_Win_Pctg(selected_Column):
    ...
    plt.title('East Teams Home Winning Percentage History')
    plt.xlabel('Time')
    ...
    plt.title('West Teams Home Winning Percentage History')
    plt.xlabel('Time')
    plt.ylabel('Percentage (%)')
    ax.yaxis.set_ticks_position('both')
    leg = plt.legend(loc='upper left', fancybox=True, fontsize=9)
